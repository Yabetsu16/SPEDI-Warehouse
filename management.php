                    ...
                    <form action="#" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <!-- Material input -->
                                <div class="md-form mt-0">
                                    <input type="text" name="project_name" class="form-control validate"
                            ...
                            <div class="col-6">
                                <!-- Material input -->
                                <div class="md-form mt-0">
                                    <input type="text" name="item_name" class="form-control validate" id="item_name"
                                        required>
                            ...
                            <div class="col-12">
                                <!-- Material input -->
                                <div class="md-form mt-0">
                                    <input type="text" name="item_description" class="form-control validate"
                            ...
                            <div class="col-6">
                                <!-- Material input -->
                                <div class="md-form mt-0">
                                    <input type="text" name="quantity_type" class="form-control validate"
                                        id="quantity_type" required>
                                    <label for="quantity_type" data-error="wrong" data-success="right">Unit</label>
                                </div>
                            </div>
                            <!-- Grid column -->
                            ...
                            <div class="col-6">
                                <!-- Material input -->
                                <div class="md-form mt-0">
                                    <input type="text" name="unit_cost" class="form-control validate" id="unit_cost"
                                        required>
                            ...
                            <div class="col-12">
                                ...
                                <div class="md-form mt-0">
                                    <input type="text" name="edit_item_description" class="form-control validate"
                                        id="edit_item_description" required>
                            ...
                            <div class="col-6">
                                ...
                                <div class="md-form mt-0">
                                    <input type="text" name="edit_quantity_type" class="form-control validate"
                                        id="edit_quantity_type" required>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <!-- Material input -->
                            <div class="md-form mt-0">
                                <input type="text" name="item_description" class="form-control disabled"
                                    id="item_description" value="Sample">
                        ...
                        <div class="col-12">
                            <!-- Material input -->
                            <div class="md-form mt-0">
                                <input type="text" name="unit_cost" class="form-control disabled" id="unit_cost"
                                    value="Sample">
                        ...
                        <div class="col-12">
                            <!-- Material input -->
                            <div class="md-form mt-0">
                                <input type="text" name="remarks" class="form-control disabled" id="remarks"
                                    value="Sample">
