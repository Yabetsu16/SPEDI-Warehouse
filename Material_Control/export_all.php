...
if ($project_id != "All") {
    ...
    $query = "SELECT
        ...
        WHERE inventory_tb.item_type = 'Materials' OR inventory_tb.item_type = 'Safety' OR inventory_tb.item_type = 'Tools' AND project_office_tb.project_id = $project_id
...
if ($project_id == "All") {
    $filename = "All Inventory Summary Report for all Projects " . date("M-d-Y");  //your_file_name
    $file_format = ".csv";   //file_extention
    ...
    INNER JOIN inventory_tb ON inventory_tb.inventory_id = movement_tb.inventory_id
    INNER JOIN project_office_tb ON project_office_tb.project_id = inventory_tb.project_id
    WHERE inventory_tb.item_type = 'Materials' OR inventory_tb.item_type = 'Safety' OR inventory_tb.item_type = 'Tools'
    ORDER BY inventory_tb.inventory_id, movement_tb.date_movement;";
